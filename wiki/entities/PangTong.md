...
title: "庞统 / Pang Tong"
type: entity
tags: [person, strategist, late-han, three-kingdoms, jingzhou]
sources:
...
庞统 / Pang Tong is a Jingzhou strategist whose current evidence joins regional talent loss under [[LiuBiao|刘表]] to early recognition by respected evaluators and later strategic usefulness.
...
- Emerges from the Jingzhou scholar and talent network.
- Receives early reputation certification from Pang Degong and Sima Hui.
- Is paired with Zhuge Liang as a high-potential adviser.
- Illustrates how a region can contain talent socially without integrating it politically.
- Is retrospectively associated with study, strategic options, and later service to Liu Bei.
...
- [[PangDegongLateHan|庞德公]] - evaluator associated with Pang Tong's early reputation.
- [[SimaHuiLateHan|司马徽]] - recommender who circulates the “凤雏” label.
- [[ZhugeLiang|诸葛亮]] - paired Jingzhou adviser in the episode's reputation frame.
- [[LiuBiao|刘表]] - ruler whose system preserves local talent but fails to retain or deploy it fully.
- [[LiuBei|刘备]] - later patron used retrospectively to test whether reputation became usable strategy.
- [[EliteEndorsementReputationMaking|名士背书式造势]] - mechanism that makes latent capacity socially visible.
- [[FenceSittingStrategicExposure|骑墙式战略暴露]] - regional strategic weakness connected to Jingzhou talent leakage.
