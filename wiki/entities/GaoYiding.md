...
[[ep261-mifeng-weiji-ruguo-shiqu-mifeng-shijie-jianghui-zenyang-lqp-cwcdxx1ziixb35ijmmvd6cv]] adds Gao's host role in a [[TalkSanlian|Talk三联]] bee-crisis episode. He frames the discussion around why familiar honeybees can open onto a wider [[WildPollinatorCrisis|wild-pollinator crisis]], then keeps the conversation connected to honey, food prices, beekeeper work, and everyday responses such as pesticide limits and urban flowering spaces.

[[ep260-yikou-feimei-zhifang-cangzhe-zhongguo-yangzhi-de-xin-gushi-linjq2fkzhqvzjcgrmhudq12vs4j]] adds Gao's host role in a [[TalkSanlian|Talk三联]] food-supply-chain episode on [[ChineseNewSpecialtyAquaculture|中国新特产养殖]]. He frames [[RainbowTrout|虹鳟]], [[Eel|鳗鱼]], and [[FoieGras|鹅肝]] as a shared question about how Chinese production changes imported or high-end food categories through water, feed, labels, processing, welfare, and domestic consumption formats.
...
Gao Yiding is the [[TalkSanlian|Talk三联]] host in [[ep270-yi-mei-xinpian-de-manchang-zhengtu-women-li-suanli-ziyou-haiyou-duoyuan-lm7lxlmcnjwnawtq-9typc-fnrci]]. He frames the episode around why chips became newly visible through AI, electric vehicles, car-chip shortages, capital-market attention, and global technology competition.

His role in the source is to keep a broad technical subject anchored in ordinary questions: why chips are everywhere, why [[GPU|GPUs]] fit AI, what fabs and packaging plants do, and how the price of compute eventually reaches users through token costs and application design.
...
- [[QiuLian]], [[Heimai]], [[BoJing]], [[RainbowTrout]], [[Eel]], [[FoieGras]], [[ChineseNewSpecialtyAquaculture]], and [[PreparedHighValueFoodFormats]] — EP260 food-supply-chain discussion.
...
- [[AIInferenceCostStructure]] — user-facing cost question at the end of the episode.
- [[XiaoChuzhou]], [[SunRuoxi]], and [[LiuChang]] — EP269 speakers.
- [[EpicModernAfterlife]], [[TheOdyssey]], [[TheEpicOfGilgamesh]], and [[PoeticEdda]] — EP269 epic-reading branch.
