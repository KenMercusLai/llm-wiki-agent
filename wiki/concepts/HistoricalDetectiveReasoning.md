...
[[zizhi-tongjian-zhouji-07-liangqi-cisha-2-lhngst3xsnyjrmzh1cvheocvvsqm]] adds two more chronicle-reading cases: [[ChronicleSourceGaps]] around the blank 395 BCE year, and the [[Zhanguoce|《战国策》]] variant in which [[NieZheng|聂政]] kills both [[XiaLei|侠累]] and [[HanAihou|韩哀侯]].

[[zizhi-tongjian-zhouji-10-yi-jiazu-danwei-you-mayi-chi-daxiang-de-jingshen-1-lq3t7lwpmq1oyb8zmmmn2tywnu8d]] adds a cautious identity and source-switching case. The host supplements a blank [[ZizhiTongjian|《资治通鉴》]] year with [[Shiji|《史记》]]'s [[TaishiDan|太史旦]] story, then treats the possible association with [[Laozi|老子]] as suggestive but unproven.
...
[[zizhi-tongjian-qinji-118-2-chi-gua-le-wangshi-de-gua-bao-tian-lns7jt-kbv3qunm66hzltdgugbco]] adds a genealogical source-test. The host does not simply accept the scandal that [[MiWan|楚考烈王]] was childless; she compares name practice, later commentary, and other Chu-lineage material to ask whether the famous story survives source comparison. This extends the method from dramatic envoy scenes and paternity rumors into royal genealogy.

[[zizhi-tongjian-qinji-126-qinshihuang-siyin-zhimi-1-lgtlhau6ixqglk1ict1fs0jexjwe]] adds an omen-narrative test through [[QinLateOmenCrisis|秦始皇晚年异象危机]]. The episode preserves the meteor inscription and "今年祖龙死" stories but asks whether the transmitted "始皇" wording fits live 211 BCE speech. The method point is that a story can remain politically meaningful as resentment, propaganda, or hindsight even when one phrase may be later-shaped.

[[zizhi-tongjian-qinji-126-qinshihuang-siyin-zhimi-2-ln15p5qb7lc20goni1ibcpmn3wca]] adds a motive-reconstruction test. The episode uses [[ZhaoZhengShu|《赵正书》]], [[Shiji|《史记》]], and [[ZizhiTongjian|《资治通鉴》]] together to infer that Qin Shi Huang's last tour may have been an attempt to change fate. The method point is to let excavated text strengthen a reading without turning a psychologically plausible reconstruction into direct access to Qin Shi Huang's mind.
...
- Genealogy claims should be tested against name practice, source layers, and rival lineage notices before being treated as a scandal's factual premise.
- Omen narratives should be tested for vocabulary, timing, and later political usefulness before their transmitted wording is treated as direct inscriptional fact.
- Excavated-text support can strengthen motive reconstruction, but inferred psychology should remain source-scoped when direct evidence is unavailable.

## Connections
- [[ZhangZhihao|张志浩]] and [[LishiBoke|《历史播客》]] - source context.
- [[TheDaughterOfTime|《时间的女儿》]], [[JosephineTey|约瑟芬·铁伊]], [[RichardIII|理查三世]], and [[PrincesInTheTower|塔中王子案]] - central historical-mystery example.
- [[CaoCaoTomb|曹操墓]] - archaeology and public-memory example.
- [[JackTheRipper]] - unsolved case where social history may matter more than suspect certainty.
...
- [[zizhi-tongjian-qinji-118-2-chi-gua-le-wangshi-de-gua-bao-tian-lns7jt-kbv3qunm66hzltdgugbco|Qinji 118-2]], [[PreQinSurnameClanIdentity|先秦姓氏身份]], [[MiWan|楚考烈王]], [[ChangpingJun|昌平君]], and [[Shiji|《史记》]] - genealogical scandal tested against name evidence and source layers.
- [[zizhi-tongjian-qinji-126-qinshihuang-siyin-zhimi-1-lgtlhau6ixqglk1ict1fs0jexjwe|Qinji 126]], [[QinLateOmenCrisis|秦始皇晚年异象危机]], [[DongCommandery|东郡]], and [[TextualVariantPoliticalStakes|史书异文政治重量]] - meteor-inscription wording tested against title usage and later anti-Qin narrative utility.
- [[zizhi-tongjian-qinji-126-qinshihuang-siyin-zhimi-2-ln15p5qb7lc20goni1ibcpmn3wca|Qinji 126 part 2]], [[ZhaoZhengShu|《赵正书》]], and [[OmenCountermeasureMobility|游徙避命]] - excavated-text support for a source-scoped final-tour motive reconstruction.
