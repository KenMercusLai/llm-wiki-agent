...
type: concept
tags: [military, command, institutions, pre-qin-history, warring-states]
...
Tiger tally command system / 虎符调兵制度 is the military credential mechanism explained in [[zizhi-tongjian-zhouji-96-maosui-zijian-6-lteqe-0ykjtv01cmxv1fhx6z0vdi]]. The episode describes a tiger-shaped tally split into two halves: the field commander holds one half, while the ruler holds the matching half used to authenticate an order.
